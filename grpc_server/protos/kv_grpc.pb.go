...
func (c *cacheClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetReply, error) {
	out := new(GetReply)
	err := c.cc.Invoke(ctx, "/kv.Cache/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cacheClient) Set(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*SetReply, error) {
	out := new(SetReply)
	err := c.cc.Invoke(ctx, "/kv.Cache/Set", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Cache_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc_server/protos/kv.proto",
}
